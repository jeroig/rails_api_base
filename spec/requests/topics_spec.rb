...
RSpec.describe '/topics', type: :request do
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      ...
      xit 'renders a JSON response with the new topic' do
        post topics_url,
             params: { topic: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      xit 'does not create a new Topic' do
        expect {
          post topics_url,
      ...
      xit 'renders a JSON response with errors for the new topic' do
        post topics_url,
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      xit 'renders a JSON response with the topic' do
        topic = Topic.create! valid_attributes
        patch topic_url(topic),
              params: { topic: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      xit 'renders a JSON response with errors for the topic' do
        topic = Topic.create! valid_attributes
        patch topic_url(topic),
              params: { topic: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
